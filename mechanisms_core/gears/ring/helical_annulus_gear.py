...
class OBJECT_OT_helical_annulus_gear(bpy.types.Operator):
    ...
    def draw(self, context):
        ...
        # is herringbone (this gear is plain helical) — a plain helical
        # gear only meshes one half of a herringbone's V at a time, and
        # which hand is correct depends on which half, something the sync
        # can't know. See gear_matching.hand_target_ambiguous.
